...
class TestShellCommandValidationUrlRetry(unittest.TestCase):
    def test_validation_script_missing_url_auto_retry_with_default_url(self):
        ...
        self.assertIn("https://example.com", str(result.get("stdout") or ""))
        ...
        self.assertEqual(str(auto_retry.get("fallback_url") or ""), "https://example.com")
